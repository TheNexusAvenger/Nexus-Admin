...
function Command:__new()
    ...
    self.Name = "bind"
	self.Aliases = {}
	self.Description = "Binds a command string to a key or mouse input."
...
--]]
function Command:RunCommand(context, bind, command, arguments)
    ...
    if bindType == "userInput" then
        binds[bind] = self.UserInputService.InputBegan:Connect(function(input, gameProcessed)
